:filename: dukecon/src/main/asciidoc/de/06_runtime_view.adoc
...
.Login sequence
------------------------------------------------
include::../images/login-sequence.puml[]
------------------------------------------------

["plantuml", "social-login-sequence", "svg"]
.Login sequence with social provider
------------------------------------------------
include::../images/social-login-sequence.puml[]
------------------------------------------------
