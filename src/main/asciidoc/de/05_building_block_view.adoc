:filename: dukecon/src/main/asciidoc/de/05_building_block_view.adoc
...
------------------------------------------------
include::../images/dukecon-architecture.puml[]
------------------------------------------------
...
//crashes dot/graphviz under windows 7 and on OSX as well!

["plantuml", "html5-architecture", "svg"]
------------------------------------------------
include::../images/html5-architecture.puml[]
------------------------------------------------
